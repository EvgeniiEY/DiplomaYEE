...
@AndroidEntryPoint
class MentorsFragment : Fragment(), OnUserCheckListener {
    ...
    override fun onCreateView(
        ...
        (activity as AppCompatActivity).supportActionBar?.title = getString(R.string.title_mentors)
        ...
        viewModel.edited.value?.mentionIds?.map { id ->
            onCheckUser(id)
        }
    ...
    override fun isCheckboxChecked(user: User): Boolean {
        return viewModel.isCheckboxMentors(user.id)
    }
